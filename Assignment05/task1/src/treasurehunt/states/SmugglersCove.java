...
/**
 * Represents the state Smugglers' Cove in the automaton.
 */
public class SmugglersCove implements State {
    ...
    public State transition(Action action) {
        return action == Action.A ? new PiratesIsland() : new TreasureIsland();
    }
    ...
    /**
     * Test method for SmugglersCove state.
     */
    public static void main(String[] args) {
        SmugglersCove obj = new SmugglersCove();
